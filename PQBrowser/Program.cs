...
public class Program
{
    ...
    private static void DefineAdditionalSystemSettings(Settings settings, string settingsCatergory = Settings.SystemSettingsCategory)
    {
        ...
        section.CompanyName = ("Grid Protection Alliance", "The name of the company that owns this instance of PQBrowser");
        section.CompanyAcronym = ("GPA", "The acronym representing the company that owns this instance of PQBrowser");
        section.ApplicationName = ("PQBrowser", "The application name");
