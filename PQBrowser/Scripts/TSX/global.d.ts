...
export namespace Redux {
    ...
    interface EventSearchState {
        TimeRange: PQBrowser.IReportTimeFilter,
        EventType: number[],
        EventCharacteristic: PQBrowser.IEventCharacteristicFilters,
    ...
    interface IGeneralSettings {
        ...
        DateTime: PQBrowser.TimeWindowMode
    }

    interface IEventSearchSettings {
        NumberResults: number,
        WidgetCategories: PQBrowser.IWidgetCategory[],
