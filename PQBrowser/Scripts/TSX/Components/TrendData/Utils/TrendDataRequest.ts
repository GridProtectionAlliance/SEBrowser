...
export const getTrendTimeWindow = (timeFilter: PQBrowser.IReportTimeFilter) => {
...
export const requestTrendData = (channels: number[], timeFilter: PQBrowser.IReportTimeFilter): JQuery.jqXHR<string> => {
