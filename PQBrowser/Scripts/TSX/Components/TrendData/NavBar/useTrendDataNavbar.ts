...
import { PQBrowser, TrendSearch, IMultiCheckboxOption } from '../../../global';
...
export const useTrendDataNavbar = (props: IProps) => {
    ...
    const [timeFilter, setTimeFilter] = React.useState<PQBrowser.IReportTimeFilter>(props.TimeFilter);
