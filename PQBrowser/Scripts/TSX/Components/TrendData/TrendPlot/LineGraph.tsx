...
const LineGraph = React.memo((props: ITrendWidgetProps) => {
    ...
    const oldValues = React.useRef<{ ChannelInfo: TrendSearch.ISeriesSettings[], TimeFilter: PQBrowser.IReportTimeFilter }>({ ChannelInfo: [], TimeFilter: null });
    ...
    function loadTrendData(channels: number[], cachedData: Map<string, IChartData>, timeFilter: PQBrowser.IReportTimeFilter): JQuery.jqXHR<string> {
