...
const CyclicHistogram = React.memo((props: ITrendWidgetProps) => {
    ...
    const oldValues = React.useRef<{ ChannelInfo: TrendSearch.ISeriesSettings | null, TimeFilter: PQBrowser.IReportTimeFilter | null }>({ ChannelInfo: null, TimeFilter: null });
