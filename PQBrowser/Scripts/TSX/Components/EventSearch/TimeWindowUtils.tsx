...
// Converts a PQBrowser.IReportTimeFilter to a IStartDuration object
...
export function toGemstoneFilter(filter: PQBrowser.IReportTimeFilter): IStartDuration {
...
// Converts a IStartEnd object to a PQBrowser.IReportTimeFilter
export function fromGemstoneFilter(start: string, end: string, unit: string, duration: number): PQBrowser.IReportTimeFilter {
