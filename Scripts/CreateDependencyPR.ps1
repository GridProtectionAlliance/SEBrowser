...
foreach ($repo in $gemstoneRepos) {
    ...
    if ($changes -gt 0) {
        ...
        $prLink = GeneratePR -Repository "Gemstone/$repo" -Title "Release Update" -Body "This PR was Generated by a release of PQBrowser" -mainBranch "master" -organization "Gemstone"
        $prs += $prLink
    }
}
