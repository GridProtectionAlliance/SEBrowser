    ...
    constructor(props, context) {
        ...
        this.state = {
            searchBarProps: {
                ...
                CBStatAll: (query['CBStatAll'] != undefined ? query['CBStatAll'] == 'true' : false),
                CBOpAll: (query['CBOpAll'] != undefined ? query['CBOpAll'] == 'true' : true),
                CBOpNoSwitch: (query['CBOpNoSwitch'] != undefined ? query['CBOpNoSwitch'] == 'true' : true),
                CBOpOpen: (query['CBOpOpen'] != undefined ? query['CBOpOpen'] == 'true' : true),
                CBOpClose: (query['CBOpClose'] != undefined ? query['CBOpClose'] == 'true' : true),
                CBResAll: (query['CBResAll'] != undefined ? query['CBResAll'] == 'true' : true),
                CBResNo: (query['CBResNo'] != undefined ? query['CBResNo'] == 'true' : true),
                CBResPot: (query['CBResPot'] != undefined ? query['CBResPot'] == 'true' : true),
                CBResRes: (query['CBResRes'] != undefined ? query['CBResRes'] == 'true' : true),
                CBResRei: (query['CBResRei'] != undefined ? query['CBResRei'] == 'true' : true),
                CBResResPol: (query['CBResResPol'] != undefined ? query['CBResResPol'] == 'true' : true),
                CBResReiPol: (query['CBResReiPol'] != undefined ? query['CBResReiPol'] == 'true' : true),
            },
        };
    }
